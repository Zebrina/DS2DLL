...
public:
	...
	DefineConstMethod(TestDebugHudOptions, 0x4093d2, bool, Params(eDebugHudOptions unk1), Args(unk1));
	DefineConstMethod(TestDebugHudOptionsEq, 0x4093e5, bool, Params(eDebugHudOptions unk1), Args(unk1));
	...
	DefineMethod(RCSetDifficulty, 0x83c5ad, FuBi::Cookie__*, Params(eDifficulty unk1), Args(unk1));
	DefineMethod(RCSyncOnMachineHelper, 0x83d156, FuBi::Cookie__*, Params(unsigned long unk1, const_mem_ptr unk2), Args(unk1, unk2));
	DefineMethod(ClearDebugHudOptions, 0x4093b6, void, Params(eDebugHudOptions unk1), Args(unk1));
	...
	DefineMethod(SetDebugHudOptions, 0x409396, void, Params(eDebugHudOptions unk1, bool unk2), Args(unk1, unk2));
	...
	DefineMethod(ToggleDebugHudOptions, 0x4093c5, void, Params(eDebugHudOptions unk1), Args(unk1));
};
