//!/////////////////////////////
//
// Source: https://github.com/glampert/reverse-engineering-dungeon-siege/blob/master/source/thirdparty/gpg/GoidScid.h
//
//!/////////////////////////////
...
#define COMPILER_ASSERT(boolexpr) STATIC_ASSERT(boolexpr)
#define FUBI_REPLACE_NAME(...)
#define FUBI_EXPORT_POINTER_CLASS(...)
#define FUBI_EXPORT
#define FUBI_DOC(...)
#define FUBI_MEMBER_DOC(...)
#define gpassert(...) ASSERT(...)
...
// Handle definition.
    ...
    FUBI_REPLACE_NAME( "Goid", Goid );
    FUBI_EXPORT_POINTER_CLASS( Goid );
...
// Constants.
    ...
    extern const Goid GoidINVALID;
    extern const Goid GoidANY;
    extern const Goid GoidNONE;
...
// Support.
    ...
    inline bool  IsGlobalGoid     ( Goid g )    {  return ( (g != GoidINVALID) && (GetGoidClass( g ) == GO_CLASS_GLOBAL) );  }
...
// Structure.
    ...
    // Constants.
        ...
        FUBI_EXPORT static Goid GetInvalidGoid( void )  {  return ( GoidINVALID );  }
        FUBI_MEMBER_DOC(        GetInvalidGoid, "", "Returns the invalid Goid constant." );

        FUBI_EXPORT static Goid GetAnyGoid( void )  {  return ( GoidANY );  }
        FUBI_MEMBER_DOC(        GetAnyGoid, "", "Returns the 'any' Goid constant." );

        FUBI_EXPORT static Goid GetNoneGoid( void )  {  return ( GoidNONE );  }
...
// Collections.
    ...
    {
        void Translate( GoidColl& out ) const           { Translate( out, GoidINVALID ); }
...
// Handle definition.
    ...
    FUBI_REPLACE_NAME( "Scid", Scid );
    FUBI_EXPORT_POINTER_CLASS( Scid );
...
// Constants.
    ...
    extern const Scid ScidINVALID;     // bad scid
    extern const Scid ScidSPAWNED;     // no scid - this go was spawned directly from template

// Inline support.

           bool IsValid   ( Scid s, bool testExists = true );
    inline bool IsInstance( Scid s, bool testExists = true )    {  return ( (s != ScidSPAWNED) && IsValid( s, testExists ) );  }
...
// Structure.
    ...
    // Constants.
        ...
        FUBI_EXPORT static Scid GetInvalidScid( void )  {  return ( ScidINVALID );  }
        FUBI_MEMBER_DOC(        GetInvalidScid, "", "Returns the invalid Scid constant." );

        FUBI_EXPORT static Scid GetSpawnedScid( void )  {  return ( ScidSPAWNED );  }
