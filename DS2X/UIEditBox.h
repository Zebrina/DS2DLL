...
public:
	...
	DefineConstMethod(GeteJustification, 0x4100e3, eJustification, NO_PARAMS, NO_ARGS);
	...
	DefineMethod(SeteJustification, 0x4100ea, void, Params(eJustification unk1), Args(unk1));
