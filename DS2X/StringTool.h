...
namespace StringTool { // Exported as: String
	...
	DefineFunction(GetLength, 0x99735d, int, Params(const gpbstring<char>& str), Args(str));
	DefineFunction(GetFileNameOnly, 0x99733f, gpbstring<char>, Params(const gpbstring<char>& str), Args(str));
	DefineFunction(Left, 0x99754d, gpbstring<char>, Params(const gpbstring<char>& str, int unk2), Args(str, unk2));
	DefineFunction(Right, 0x9975af, gpbstring<char>, Params(const gpbstring<char>& str, int unk2), Args(str, unk2));
	DefineFunction(Mid, 0x997584, gpbstring<char>, Params(const gpbstring<char>& str, int unk2), Args(str, unk2));
	DefineFunction(Mid, 0x997568, gpbstring<char>, Params(const gpbstring<char>& str, int unk2, int unk3), Args(str, unk2, unk3));
	DefineFunction(Append, 0x997371, gpbstring<char>&, Params(gpbstring<char>& str, const char* unk2), Args(str, unk2));
	DefineVarArgFunction(AppendF, 0x9973ae, gpbstring<char>&, Params(gpbstring<char>& str, const char* unk2), Args(str, unk2));
	DefineFunction(Assign, 0x99745f, gpbstring<char>&, Params(gpbstring<char>& str, const char* unk2), Args(str, unk2));
	DefineVarArgFunction(AssignF, 0x99749c, gpbstring<char>&, Params(gpbstring<char>& str, const char* unk2), Args(str, unk2));
	DefineFunction(PadFrontToLength, 0x99772a, void, Params(gpbstring<char>& str, char unk2, unsigned int unk3), Args(str, unk2, unk3));
	DefineFunction(PadBackToLength, 0x997740, void, Params(gpbstring<char>& str, char unk2, unsigned int unk3), Args(str, unk2, unk3));
}
